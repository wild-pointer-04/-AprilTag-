...
### 4. 统计报告（summary_report.txt）

```
================================================================================
基于鲁棒AprilTag系统的相机倾斜检测统计报告
================================================================================

系统配置:
  AprilTag家族: tagStandard41h12
  AprilTag尺寸: 0.071mm
  圆点间距: 0.065mm
  最大重投影误差: 1.0px
  网格尺寸: 15×15
...
相机倾斜角度统计:
  Roll:  平均=+0.15°, 标准差=0.05°, 最大=0.25°
  Pitch: 平均=-0.08°, 标准差=0.03°, 最大=0.15°
  Yaw:   平均=+0.03°, 标准差=0.02°, 最大=0.08°
...
使用的PnP方法统计:
  ITERATIVE_WITH_APRILTAG: 85 次 (89.5%)
  SQPNP_WITH_APRILTAG: 8 次 (8.4%)
  STANDARD_FALLBACK: 2 次 (2.1%)
